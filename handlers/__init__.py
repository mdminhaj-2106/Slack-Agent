...
from handlers.verifier import register_verifier_handlers

def register_handlers(slack_app: App):
    """
    Orchestrates listener registrations for all events and action payloads
    ...
    register_verifier_handlers(slack_app)